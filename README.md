...
[English](README.en.md) · [Релизы](https://github.com/rshagiev/webm-tv/releases) · [Запустить у себя](#запустить-у-себя) · [Смотреть на телефоне](#смотреть-на-телефоне)
...
*Стартовый экран и выбор каналов при ширине экрана 390 px.*

Установка приложения на телефон не нужна — откройте сайт в браузере. Сервер работает на компьютере:
